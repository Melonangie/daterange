...
$env[MYSQL] = [
  ...
  'DB_MYSQL_COLLATE' => filter_var($_ENV['DB_MYSQL_COLLATE'], FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH),
];
...
$db_configs = [
  ...
  PDO => [
    ...
    PDO::MYSQL_ATTR_INIT_COMMAND => sprintf('SET NAMES %s COLLATE %s', $env[MYSQL]['DB_MYSQL_CHARSET'], $env[MYSQL]['DB_MYSQL_COLLATE']),
  ],
];
